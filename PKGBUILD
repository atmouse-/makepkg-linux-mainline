...
pkgbase=linux-megx570               # Build stock -ARCH kernel
...
_srcname=linux
source=(
  "$_srcname::git+https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git#tag=$_tag"
